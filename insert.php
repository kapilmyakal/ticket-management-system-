 <?php
     ...
     if (count(array($data)) > 0) {
          ...
          if ($btnname_received == 'ADD') {
               $query = "INSERT INTO trackingdetails(name, phone, status) VALUES ('$name_received', '$phone_received','$status_received')";
          ...
          if ($btnname_received == 'Update') {
               ...
               $query = "UPDATE trackingdetails SET name = '$name_received', phone = '$phone_received', status = '$status_received' WHERE id = '$id_received'";
